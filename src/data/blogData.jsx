...
const blogData = [
    ...
    },
    {
        ...
        descriptionFour: "Fast forward to today – I'm a proud graduate. The struggles, the late nights in the computer lab, and the laundry chores all led to this moment. Now, I'm on the lookout for job opportunities, aiming to kickstart my career in January 2024.",
        descriptionFive: "To my fellow developers battling emotional and financial storms, remember this: failure is not the end; it's a stepping stone to improvement. Don't surrender when you feel like a failure; use that feeling to propel yourself forward. As developers, we're problem solvers by nature. Keep moving, keep learning, and bravo to all of you! In the grand scheme of coding, every bug conquered, every hurdle overcome, and every challenge faced only makes us better developers. Embrace the journey, and remember – the code may be complex, but the solutions are within your reach. You'll get there. Bravo! 🚀",

...
export default [
    {
        ...
        icon: githubIcon,
        gitHub: 'https://github.com/Chrlstian/ChristianCaponProfilePortfolio/blob/main/PiggeryAndMeat.html'
    },
    {
        id: 2,
        stack: 'HTML & CSS',
        ...
        icon: githubIcon,
        gitHub: 'https://github.com/Chrlstian/ChristianCaponProfilePortfolio/blob/main/philiWonders.html'
    },
    {
        id: 3,

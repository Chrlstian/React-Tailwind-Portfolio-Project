            ...
            <div className="p-2 hover:border hover:border-gray-500 rounded">
                <div className="max-w-screen-2xl md:flex lg:items-center 2xl:m-auto gap-0">
                    <div className="w-full md:pt-4 ">
                        ...
                        <div className="pt-4 text-txt">Visit the site @<a className="hover:underline text-blue-500" href={props.item.url} target="_blank" rel="noreferrer"> {props.item.url}</a></div>
                    </div>
                    <div className="flex flex-col gap-3 mt-2 md:pl-5 lg:p-5 lg:pr-0 lg:pt-5 lg:pb-5 w-full">

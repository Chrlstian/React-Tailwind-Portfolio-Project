  ...
  return (
    <div className={`heroContainer-md max-w-screen-2xl 2xl:m-auto ${props.lightMode ? 'bg-white' : 'bg-black'}`}>
      <div className='hero-info sm:gap-10 lg:pl-8 xl:p-20 xl:max-w'>
        <h1 className={`font-body text-4xl text-center sm:text-5xl lg:text-start lg:text-6xl ${props.lightMode ? 'text-black md:text-secondary' : 'text-gray-200' }`}>Helping people make the world a better place through quality <span className='text-pink-700'>software solutions.</span></h1>
        <p className='text-center text-txt md:text-lg'>"Hi, I'm Christian, a Junior software developer excited to build amazing things for you."</p>

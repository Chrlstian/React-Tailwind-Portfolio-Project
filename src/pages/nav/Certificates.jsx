...
export default function Certificates(props){
    ...
    return(
        <>
            <h2 className={`text-center font-bold text-2xl mt-10 md:mb-8 lg:mb-10 md:text-3xl lg:text-4xl xl:text-5xl ${props.lightMode ? 'text-primary' : 'text-gray-200'}`}>The Certificates</h2>
